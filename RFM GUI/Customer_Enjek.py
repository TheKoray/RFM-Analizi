# -*- coding: utf-8 -*-
"""
Created on Fri Oct 22 15:53:54 2021
...
data = pd.read_excel("enjektör_conta.xlsx")
...
# CustomerCode ve CustomerName değişkenlerinin 1 tane Eksik Değeri bulunmaktadır.
...
champions_enjek = rfm[rfm['Segment'] == 'Champions']

a_sleep_enjek = rfm[rfm['Segment'] == 'About to Sleep']

risk_enjek = rfm[rfm['Segment'] == 'At Risk']
    
new_cus_enjek = rfm[rfm['Segment'] == 'New Customers'] 

promising_enjek = rfm[rfm['Segment'] == 'Promising']
    
attention_enjek = rfm[rfm['Segment'] == 'Need Attention']

#%% Arayüzde kullanmak için Sınıf elde edelim. Bu sınıfı modül olarak kullanacağız

class Customer_Enjek():
    
    def Champions(self):
        
        self.champions_enjek = champions_enjek.index.tolist()
        
        return self.champions_enjek
    
    def Sleep(self):
        
        self.sleep_enjek = a_sleep_enjek.index.tolist()
        
        return self.sleep_enjek
    
    def Risk(self):
        
        self.risk_enjek = risk_enjek.index.tolist()
        
        return self.risk_enjek
    
    def New(self):
        
        self.new_enjek = new_cus_enjek.index.tolist()
        
        return self.new_enjek
    
    def Promising(self):
        
        self.promising_enjek = promising_enjek.index.tolist()
        
        return self.promising_enjek
    
    def Attention(self):
        
        self.attention_enjek = attention_enjek.index.tolist()
        
        return self.attention_enjek 
