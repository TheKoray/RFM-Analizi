# -*- coding: utf-8 -*-
"""
Created on Sat Oct 23 23:40:18 2021
...
data = pd.read_excel("Balata.xlsx")
...
champions_bal = rfm[rfm['Segment'] == 'Champions']

a_sleep_bal = rfm[rfm['Segment'] == 'About to Sleep']

risk_bal = rfm[rfm['Segment'] == 'At Risk']
    
new_cus_bal = rfm[rfm['Segment'] == 'New Customers'] 

promising_bal = rfm[rfm['Segment'] == 'Promising']
    
attention_bal = rfm[rfm['Segment'] == 'Need Attention']

#%% Arayüzde kullanacağımız Segment sınıfımızı oluşturalım

class Customer_Balata():
    
    def Champions(self):
        
        self.champions_bal = champions_bal.index.tolist()
        
        return self.champions_bal
    
    def Sleep(self):
        
        self.sleep_bal = a_sleep_bal.index.tolist()
        
        return self.sleep_bal
    
    def Risk(self):
        
        self.risk_bal = risk_bal.index.tolist()
        
        return self.risk_bal
    
    def New(self):
        
        self.new_bal = new_cus_bal.index.tolist()
        
        return self.new_bal
    
    def Promising(self):
        
        self.promising_bal = promising_bal.index.tolist()
        
        return self.promising_bal
    
    def Attention(self):
        
        self.attention_bal = attention_bal.index.tolist()
        
        return self.attention_bal
